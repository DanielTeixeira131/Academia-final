...
public class cadastroI {
    ...
    public void cadastroI(instrutor a){
     try {
            ...
            comando.setDouble(4, a.getSalario());
        ...
        try {
            String SQL="SELECT telefone, cpf, nome, salario FROM daniel_c_teixeira.instrutor";
    ...
    private instrutor pegaDados(ResultSet resultado){
        try {
            ...
            atual.setSalario(resultado.getDouble("salario"));
            return atual;
        } catch (SQLException ex) {
            Logger.getLogger(cadastroI.class.getName()).log(Level.SEVERE, null, ex);
        }
