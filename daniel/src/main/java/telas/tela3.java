...
public class tela3 extends javax.swing.JFrame {
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        instrutor intr=new instrutor();
        intr.setCpf(cpf.getText());
        intr.setNome(nome.getText());
        intr.setSalario(Double.valueOf(salario.getText()));
        intr.setTelefone(telefone.getText());
        cadastroI cadastI= new cadastroI();
        cadastI.cadastroI(intr);
